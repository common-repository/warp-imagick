...
Plugin Name: Warp iMagick – Forbidden Plugin. Closed by Undisclosed at Jan 22 2022.
Author: PageSpeed Club
Contributors: pagespeedclub
License: GPLv2
Requires PHP: 5.6
Tested up to: 5.9
Stable tag: 1.9.6
Requires at least: 5.3
Tags: big images, sharpen, subsizes, thumbnails, upload
...
On-Site Compress, Optimize Image. Convert WebP. Set JPEG Quality and Sharpen. Resize on upload. Set big image threshold.

== Description ==

* **Warp iMagick – Optimize Image is EASY to use, PRIVATE and FREE.**
...
* **Warp iMagick – Image Compression is flexible, easy to configure.**
...
* **Warp iMagick – Resize on Upload, enables you to limit big image geometry, file size and save disk space.**
...
Warp iMagick image optimizer plugin will do it for you and preserve your uploaded [or automatically resized] high quality original image as source for multiple re-compressions. Never over-compress or loose thumbnail quality.
